...
void render_sprite(double x,double y,image_data image_source,SDL_Rect* texture_clip=NULL,double opacity=1.0,double scale_x=1.0,double scale_y=1.0,double angle=0.0,short color_name=COLOR_WHITE);

void render_rectangle(double x,double y,double w,double h,double opacity,short color_name);

void render_rectangle_empty(double x,double y,double w,double h,double opacity=1.0,short color_name=COLOR_WHITE,short border_width=1);

//Render text to the screen using a bitmap font.
void render_font(double x,double y,image_data image_source,SDL_Rect* texture_clip=NULL,short color_name=COLOR_WHITE,double opacity=1.0,double scale_x=1.0,double scale_y=1.0);
